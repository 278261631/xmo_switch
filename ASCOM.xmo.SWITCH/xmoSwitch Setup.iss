...
; Generated by xmo on 2023/9/20 (UTC)
;
#define Version GetDateTimeString('yy.mm.dd', '', '')
[Setup]
AppID={{234cc6f2-94c1-47db-beb6-d94e8a3d727b}
AppName=ASCOM xmoSwitch Switch Driver
AppVerName=ASCOM xmoSwitch Switch Driver {#Version}
AppVersion={#Version}
AppPublisher=xmo <mars.maya.g@gmail.com>
AppPublisherURL=mailto:mars.maya.g@gmail.com
...
OutputDir="."
OutputBaseFilename="xmoSwitch Setup {#Version}"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\xmoSwitch"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\xmoSwitch"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "E:\switch\src\ASCOM.xmo.SWITCH\bin\Debug\*.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
;Source: "E:\switch\src\ASCOM.xmo.SWITCH\ReadMe.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.xmo.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.xmo.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.xmo.Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.xmo.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.xmo.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
